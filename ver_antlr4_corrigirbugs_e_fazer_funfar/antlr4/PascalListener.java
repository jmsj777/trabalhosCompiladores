...
public interface PascalListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link PascalParser#principal}.
	 * @param ctx the parse tree
	 */
	void enterPrincipal(PascalParser.PrincipalContext ctx);
	/**
	 * Exit a parse tree produced by {@link PascalParser#principal}.
	 * @param ctx the parse tree
	 */
	void exitPrincipal(PascalParser.PrincipalContext ctx);
	/**
